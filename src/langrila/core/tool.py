...
class FunctionValidator:
    ...
    Pydantic model is dynamically created from the function's type hints and docstring.
    If the function has type hints, the schema will be generated from them.
